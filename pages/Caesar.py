...
with tab1:
    ...
    with col2:
        st.write("The Caesar Cipher is one of the earliest known cryptographic algorithms. It is named after Julius Caesar who initially used it to protect sensitive military messages, allowing him to communicate with his military generals.  ")
