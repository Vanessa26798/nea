...
with tab4: 
    ...
    chart_data = pd.DataFrame({"Character": Character, "hi": Highest_Occurance_Character, "Occurance": Occurance})
    st.bar_chart(chart_data, x = "Character", y = ["Occurance", "hi"], horizontal=True, color=["#FF0000", "#0000FF"])
